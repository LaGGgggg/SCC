...
PYRAMID_1 = Figure(
    vertices=(
        ...
        (2.54410162, 2, 1.57),  # calculated for: __PYRAMID_HEIGHT = __PYRAMID_SIDE = 4
    ),
    vertices_names=('A', 'B', 'C', 'S', 'O', 'N', 'M'),
    faces=(
        # counterclockwise:
        (0, 1, 3),
        (1, 2, 3),
    ...
    additional_lines=(
        AdditionalLine(5, 6, (0,), is_always_hided=True, color=BLUE),
    ),
    faces_vertices_special_colors=(
        (1, (
            (1, 2, BLUE, Thickness(THICKNESS_DEFAULT)),
            (1, 3, BLUE, Thickness(THICKNESS_DEFAULT)),
            (2, 3, BLUE, Thickness(THICKNESS_DEFAULT)),
        )),
        (0, ((1, 3, BLUE, Thickness(THICKNESS_DEFAULT)),)),
        (2, ((2, 3, BLUE, Thickness(THICKNESS_DEFAULT)),)),
        (3, ((1, 2, BLUE, Thickness(THICKNESS_DEFAULT)),)),
    ),
)
...
PYRAMID_2 = Figure(
    ...
    vertices_names=('A', 'B', 'C', 'S', 'O', 'N', 'M', 'x', 'z', 'y'),
    faces=(
        # counterclockwise:
        (0, 1, 3),
        (1, 2, 3),
